...
export default function Toggle({ enabled, onChange }: ToggleProps) {
    ...
    return (
        <Switch
            checked={enabled}
            onChange={onChange}
            className="group relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:outline-hidden data-checked:bg-blue-600"
        >
        ...
        >
          <svg fill="currentColor" viewBox="0 0 12 12" className="size-3 text-blue-600">
